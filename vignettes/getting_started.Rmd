...
|---|---|---|
| **Tables** | Cohort metadata, ground truth annotation tables | `get_metadata()`, `get_ground_truth_cna()`, `get_ground_truth_drivers()`, `get_ground_truth_exposures()`, `get_sampling_information()` |
...
Cohort annotation tables are stored as public Google Sheets. All functions
return tibbles directly — no authentication required.
