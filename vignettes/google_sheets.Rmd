...
Cohort-level tables are stored as public Google Sheets and are accessible
directly as tibbles — no authentication or extra packages required.
...
Returns a tibble of ground truth copy number segments. Can be filtered by
SPN and/or sample.
...
sampling time, and clone proportions. Can be filtered by SPN and/or sample.
...
Generic reader for any public Google Sheet. Useful for accessing additional
tables not yet wrapped by a dedicated function.
